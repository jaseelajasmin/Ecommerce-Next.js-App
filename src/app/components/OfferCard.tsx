...
export default function ProductCard(props:any) {
  ...
  return (
    <div >
       ...
       <div className="card" style={{width: '17rem',height:'300px',padding:'10px',marginTop:'-80px',marginBottom:'90px'}}>
        ...
        <img src={prod.image2}height={'80'} width={'40'}className="card-img-top" alt="..."></img>
        ...
        <img src={prod.image4}height={'80'} width={'50'}className="card-img-top" alt="..."></img>
